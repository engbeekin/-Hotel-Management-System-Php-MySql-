...
<html lang="en">
  ...
  <h1 class=" text-center" style="margin-top: 70px;">All Customer  Info</h1> 
...
<div>
<input id="myInput" type="text" placeholder="Search customer here" class=" form-control" style="width: 300px; 
 margin-left:1000px">
                </div>
                <br>
